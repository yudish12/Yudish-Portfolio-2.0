...
const Header = () => {
	return (
		<nav className='flex justify-between w-full py-6 top-0 items-center fixed z-20 bg-black px-12 border-b-2 border-gray-400' >
			<div className="left text-[#C7C7C7] bebas-neue text-3xl">YUDISH&apos;S &nbsp; PORTFOLIO</div>
			<div className="right text-[#C7C7C7] bebas-neue text-xl md:flex hidden gap-6 ">
